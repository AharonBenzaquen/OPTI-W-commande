...
export default function App() {
  ...
  const [commande, setCommande] = useState({ numero: '', client: '', date: '', statut: 'En attente' });
  ...
  const ajouterCommande = () => {
    ...
    setCommande({ numero: '', client: '', date: '', statut: 'En attente' });
  };
      ...
      <table border="1" cellPadding="6" style={{ marginTop: 10, width: '100%' }}>
        <thead>
          <tr>
            ...
            <th>Statut</th>
            <th>Délai</th>
            {(role === 'admin' || role === 'employe') && <th>Actions</th>}
          </tr>
        </thead>
        <tbody>
